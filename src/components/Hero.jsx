...
import modernRoom from "../assets/modelimg.png";
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-blue-200 rounded-full blur-xl opacity-20 animate-pulse"></div>
          <div className="absolute top-40 right-10 w-72 h-72 bg-purple-200 rounded-full blur-xl opacity-20 animate-pulse"></div>
          <div className="absolute -bottom-8 left-40 w-72 h-72 bg-pink-200 rounded-full blur-xl opacity-20 animate-pulse"></div>
        </div>
            ...
            <div className="text-center lg:text-left space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  Thoughtfull design that blends your style, comfort and value — Our
                  designers bring every vision to life with care and creativity.
                </p>
              </div>
      ...
      {openForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="relative bg-white w-[95%] md:w-[80%] lg:w-[60%] h-[90vh] rounded-2xl shadow-2xl">

            {/* Close Button */}
            <button
              onClick={() => setOpenForm(false)}
              className="absolute top-3 right-4 text-2xl font-bold text-gray-600 hover:text-red-500 z-50"
            >
              ✕
            </button>
            ...
            {/* Google Form */}
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSeOjUZUMwgN2fwS9HeCMk6IxKY4SfCgZN2UpEbgYhp7pxzDig/viewform?embedded=true"
